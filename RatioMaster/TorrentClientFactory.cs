namespace RatioMaster {
  public static class TorrentClientFactory {
    ...
    public static TorrentClient GetClient(string name) {
      var client = new TorrentClient(name);
      switch (name) {
        #region BitComet
        ...
        case "BitComet 1.20": {
          ...
          client.Key = GenerateIdString("numeric", 5, false);
          client.Headers =
        ...
        case "Vuze 4.2.0.8": {
          ...
          client.HttpProtocol = "HTTP/1.1";
          client.HashUpperCase = true;
          client.Key = GenerateIdString("alphanumeric", 8, false);
          client.Headers =
            "User-Agent: Azureus 4.2.0.8;Windows XP;Java 1.6.0_05\r\nConnection: close\r\nAccept-Encoding: gzip\r\nHost: {host}\r\nAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\r\n";
          client.PeerID = "-AZ4208-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
        ...
        case "Azureus 3.1.1.0": {
          ...
          client.Key = GenerateIdString("alphanumeric", 8, false);
          client.Headers =
            "User-Agent: Azureus 3.1.1.0;Windows XP;Java 1.6.0_07\r\nConnection: close\r\nAccept-Encoding: gzip\r\nHost: {host}\r\nAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\r\n";
          client.PeerID = "-AZ3110-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&supportcrypto=1&port={port}&azudp={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0{event}&numwant={numwant}&no_peer_id=1&compact=1&key={key}&azver=3";
          client.DefNumWant = 50;
          client.Parse = true;
        ...
        case "Azureus 3.0.5.0": {
          ...
          client.Key = GenerateIdString("alphanumeric", 8, false);
          client.Headers =
            "User-Agent: Azureus 3.0.5.0;Windows XP;Java 1.6.0_05\r\nConnection: close\r\nAccept-Encoding: gzip\r\nHost: {host}\r\nAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\r\nContent-type: application/x-www-form-urlencoded\r\n";
          client.PeerID = "-AZ3050-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&supportcrypto=1&port={port}&azudp={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0{event}&numwant={numwant}&no_peer_id=1&compact=1&key={key}&azver=3";
          client.DefNumWant = 50;
          client.Parse = true;
        ...
        case "Azureus 3.0.4.2": {
          ...
          client.Key = GenerateIdString("alphanumeric", 8, false);
          client.Headers =
            "User-Agent: Azureus 3.0.4.2;Windows XP;Java 1.5.0_07\r\nConnection: close\r\nAccept-Encoding: gzip\r\nHost: {host}\r\nAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\r\nContent-type: application/x-www-form-urlencoded\r\n";
          client.PeerID = "-AZ3042-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&supportcrypto=1&port={port}&azudp={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0{event}&numwant={numwant}&no_peer_id=1&compact=1&key={key}&azver=3";
          client.DefNumWant = 50;
          client.Parse = true;
        ...
        case "Azureus 3.0.3.4": {
          ...
          client.Key = GenerateIdString("alphanumeric", 8, false);
          client.Headers =
            "User-Agent: Azureus 3.0.3.4;Windows XP;Java 1.6.0_03\r\nConnection: close\r\nAccept-Encoding: gzip\r\nHost: {host}\r\nAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\r\n";
          client.PeerID = "-AZ3034-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&supportcrypto=1&port={port}&azudp={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0{event}&numwant={numwant}&no_peer_id=1&compact=1&key={key}&azver=3";
          client.DefNumWant = 50;
          client.Parse = true;
        ...
        case "Azureus 3.0.2.2": {
          ...
          client.Key = GenerateIdString("alphanumeric", 8, false);
          client.Headers =
            "User-Agent: Azureus 3.0.2.2;Windows XP;Java 1.6.0_01\r\nConnection: close\r\nAccept-Encoding: gzip\r\nHost: {host}\r\nAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\r\n";
          client.PeerID = "-AZ3022-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&supportcrypto=1&port={port}&azudp={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0{event}&numwant={numwant}&no_peer_id=1&compact=1&key={key}&azver=3";
          client.DefNumWant = 50;
          client.Parse = true;
        ...
        case "Azureus 2.5.0.4": {
          ...
          client.Key = GenerateIdString("alphanumeric", 8, false);
          client.Headers =
            "User-Agent: Azureus 2.5.0.4;Windows XP;Java 1.5.0_10\r\nConnection: close\r\nAccept-Encoding: gzip\r\nHost: {host}\r\nAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\r\nContent-type: application/x-www-form-urlencoded\r\n";
          client.PeerID = "-AZ2504-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&supportcrypto=1&port={port}&azudp={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}{event}&numwant={numwant}&no_peer_id=1&compact=1&key={key}&azver=3";
          client.DefNumWant = 50;
          client.Parse = true;
        ...
        case "uTorrent 3.3.2": {
          ...
          client.PeerID = "-UT3320-%18w" + GenerateIdString("random", 10, true);
          client.Query =
        ...
        case "uTorrent 3.3.0": {
          ...
          client.PeerID = "-UT3300-%b9s" + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 3.2.0": {
          ...
          client.PeerID = "-UT3200-z8\0." + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 2.0.1 (build 19078)": {
          ...
          client.PeerID = "-UT2010-%86J" + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 1.8.5 (build 17414)": {
          ...
          client.PeerID = "-UT1850-%06D" + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 1.8.1-beta(11903)": {
          ...
          client.PeerID = "-UT181B-%7f." + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 1.8.0": {
          ...
          client.PeerID = "-UT1800-%25." + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&corrupt=0&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 1.7.7": {
          ...
          client.PeerID = "-UT1770-%f3%9f" + GenerateIdString("random", 10, true);
          client.Query =
        ...
        case "uTorrent 1.7.6": {
          ...
          client.PeerID = "-UT1760-%b3%9e" + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 1.7.5": {
          ...
          client.PeerID = "-UT1750-%fa%91" + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 1.6.1": {
          ...
          client.PeerID = "-UT1610-%ea%81" + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "uTorrent 1.6": {
          ...
          client.PeerID = "-UT1600-%d9%81" + GenerateIdString("random", 10, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = true;
        ...
        case "BitTorrent 6.0.3 (8642)": {
          ...
          client.PeerID = "M6-0-3--" + GenerateIdString("random", 12, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&key={key}{event}&numwant={numwant}&compact=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = false;
        ...
        case "Transmission 2.82 (14160)": {
          ...
          client.PeerID = "-TR2500-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&numwant={numwant}&key={key}&compact=1&supportcrypto=1{event}";
        ...
        case "Transmission 2.92 (14714)": {
          ...
          client.PeerID = "-TR2920-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&numwant={numwant}&key={key}&compact=1&supportcrypto=1{event}";
          client.DefNumWant = 80;
        ...
        case "ABC 3.1": {
          ...
          client.HttpProtocol = "HTTP/1.1";
          client.HashUpperCase = true;
          client.Key = GenerateIdString("alphanumeric", 6, false);
          client.Headers = "Host: {host}\r\nUser-Agent: ABC/ABC-3.1.0\r\nAccept-Encoding: gzip\r\n";
          client.PeerID = "A310--" + GenerateIdString("alphanumeric", 14, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&trackerid=48&no_peer_id=1&compact=1{event}&key={key}";
          client.Parse = true;
        ...
        case "BitLord 1.1": {
          ...
          client.HashUpperCase = true;
          client.Key = GenerateIdString("numeric", 4, false);
          client.Headers =
            "User-Agent: BitTorrent/3.4.2\r\nConnection: close\r\nAccept-Encoding: gzip, deflate\r\nHost: {host}\r\nCache-Control: no-cache\r\n";
          client.PeerID = "exbc%01%01LORDCz%03%92" + GenerateIdString("random", 6, true, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&natmapped=1&uploaded={uploaded}&downloaded={downloaded}&left={left}&numwant=200&compact=1&no_peer_id=1&key={key}{event}";
          break;
        }
        ...
        case "BTuga 2.1.8": {
          ...
          client.PeerID = "R26---" + GenerateIdString("alphanumeric", 14, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&no_peer_id=1&compact=1{event}&key={key}";
          break;
        }
        ...
        case "BitTornado 0.3.17": {
          ...
          client.PeerID = "T03H-----" + GenerateIdString("alphanumeric", 11, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&no_peer_id=1&compact=1{event}&key={key}";
        ...
        case "Burst 3.1.0b": {
          ...
          client.HttpProtocol = "HTTP/1.0";
          client.HashUpperCase = true;
          client.Key = GenerateIdString("hex", 8, false);
          client.Headers = "Host: {host}\r\nAccept-Encoding: gzip\r\nUser-Agent: BitTorrent/brst1.1.3\r\n";
          client.PeerID = "Mbrst1-1-3" + GenerateIdString("hex", 10, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&key={key}&uploaded={uploaded}&downloaded={downloaded}&left={left}&compact=1{event}";
          break;
        }
        ...
        case "BitTyrant 1.1": {
          ...
          client.Key = GenerateIdString("alphanumeric", 8, false);
          client.Headers =
            "User-Agent: AzureusBitTyrant 2.5.0.0BitTyrant;Windows XP;Java 1.5.0_10\n\rConnection: close\n\rAccept-Encoding: gzip\n\rHost: {host}\n\rAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\n\rProxy-Connection: keep-alive\n\rContent-type: application/x-www-form-urlencoded\n\r";
          client.PeerID = "AZ2500BT" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&supportcrypto=1&port={port}&azudp={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}{event}&numwant={numwant}&no_peer_id=1&compact=1&key={key}";
          client.DefNumWant = 50;
          break;
        }
        ...
        case "BitSpirit 3.6.0.200": {
          ...
          client.PeerID = "%2dSP3602" + GenerateIdString("random", 13, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}{event}&key={key}&compact=1&numwant={numwant}&no_peer_id=1";
          client.DefNumWant = 200;
          break;
        }
        ...
        case "BitSpirit 3.1.0.077": {
          ...
          client.HttpProtocol = "HTTP/1.0";
          client.HashUpperCase = false;
          client.Key = GenerateIdString("numeric", 3, false);
          client.Headers = "User-Agent: BitTorrent/4.1.2\r\nHost: {host}\r\nAccept-Encoding: gzip\r\nConnection: close";
          client.PeerID = "%00%03BS" + GenerateIdString("random", 16, true);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}{event}&key={key}&compact=1&numwant={numwant}";
          client.DefNumWant = 200;
          break;
        }
        ...
        case "Deluge 1.2.0": {
          ...
          client.PeerID = "-DE1200-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
        ...
        case "Deluge 0.5.8.7": {
          ...
          client.PeerID = "-DE0587-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&event={event}&key={key}&compact=1&numwant={numwant}&supportcrypto=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = false;
        ...
        case "Deluge 0.5.8.6": {
          ...
          client.PeerID = "-DE0586-" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&event={event}&key={key}&compact=1&numwant={numwant}&supportcrypto=1&no_peer_id=1";
          client.DefNumWant = 200;
          client.Parse = false;
        ...
        case "KTorrent 2.2.1": {
          ...
          client.HttpProtocol = "HTTP/1.1";
          client.HashUpperCase = false;
          client.Key = GenerateIdString("numeric", 10, false);
          client.Headers =
            "User-Agent: ktorrent/2.2.1\r\nAccept: text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2\r\nAccept-Encoding: x-gzip, x-deflate, gzip, deflate\r\nHost: {host}\r\nConnection: Keep-Alive\n\r";
          client.PeerID = "-KT2210-" + GenerateIdString("numeric", 12, false);
          client.Query =
            "peer_id={peerid}&port={port}&uploaded={uploaded}&downloaded={downloaded}&left={left}&compact=1&numwant={numwant}&key={key}{event}&info_hash={infohash}";
        ...
        case "Gnome BT 0.0.28-1": {
          ...
          client.PeerID = "M3-4-2--" + GenerateIdString("alphanumeric", 12, false);
          client.Query =
            "info_hash={infohash}&peer_id={peerid}&port={port}&key={key}&uploaded={uploaded}&downloaded={downloaded}&left={left}&compact=1{event}";
          client.DefNumWant = 100;
          break;
